...
const INITIAL_DEFAULT_TASKS = [
  // TASK 1: Start Date End Date (5 Subtasks)
  {
    ...
    measureTarget: 15.0,
    measureUnit: 'units',
    loggedMeasureVal: 15.0,
    lastMeasuredValue: 15.0,
    isOptional: false,
    isDoneToday: false,
    progressPercent: 61,
    parentTaskId: ''
  ...
  // TASK 4: Single Optional Subtask Parent (Reading Plan)
  {
    ...
    measureTarget: 25.0,
    measureUnit: 'pages',
    loggedMeasureVal: 25.0,
    lastMeasuredValue: 25.0,
    isOptional: false,
    isDoneToday: false,
    progressPercent: 67,
    parentTaskId: ''
  },
  {
    id: 'st-4-1',
    user_id: 'default-user',
    title: 'Subtask 4.1 — Optional Notes Summary',
    category: 'Reading',
    priority: 'LOW',
    trackingMode: 'end_date',
    hasMeasureTracking: false,
  ...
  // TASK 5: Standalone Task with No Measure (Mindfulness Challenge)
  {
  ...
  // TASK 6: Parent Task No Measure with 5 Children (Software Engineering)
  {
  ...
  },
  {
    id: 'st-6-1',
    user_id: 'default-user',
    title: 'Subtask 6.1 — Pull Request Code Reviews',
    category: 'Engineering',
    priority: 'CRITICAL',
    trackingMode: 'end_date',
    hasMeasureTracking: true,
  ...
  },
  {
    id: 'st-6-2',
    user_id: 'default-user',
    title: 'Subtask 6.2 — API Integration Test Suites',
    category: 'Engineering',
    priority: 'HIGH',
    trackingMode: 'count_days',
    hasMeasureTracking: true,
  ...
  },
  {
    id: 'st-6-3',
    user_id: 'default-user',
    title: 'Subtask 6.3 — Database Performance Profiling',
    category: 'Engineering',
    priority: 'HIGH',
    trackingMode: 'count_event',
    hasMeasureTracking: true,
  ...
  },
  {
    id: 'st-6-4',
    user_id: 'default-user',
    title: 'Subtask 6.4 — Architecture Documentation Refactor',
    category: 'Engineering',
    priority: 'MEDIUM',
    trackingMode: 'end_date',
    hasMeasureTracking: false,
  ...
  },
  {
    id: 'st-6-5',
    user_id: 'default-user',
    title: 'Subtask 6.5 — Optional Demo Video Recording',
    category: 'Engineering',
    priority: 'LOW',
    trackingMode: 'end_date',
    hasMeasureTracking: false,
