...
const INITIAL_DEFAULT_TASKS = [
  {
    ...
    title: 'Test1',
    description: 'Mastering Advanced Java & Spring Boot Microservices over a 45-day fixed schedule window.',
    collab: 'Dev Team',
    priority: 'CRITICAL',
    isOptional: false,
  ...
  },
  {
    ...
    user_id: 'default-user',
    title: 'Child 1.1 - Spring Data JPA Exercises (Mandatory, Measured)',
    description: 'Practical exercise submissions.',
    collab: '',
    priority: 'HIGH',
    isOptional: false,
    hasMeasureTracking: true,
    measureUnit: 'Exercises',
    measureTarget: 5,
    progressPercent: 48,
    plannedStart: '2026-08-10',
  ...
  },
  {
    ...
    user_id: 'default-user',
    title: 'Child 1.2 - JDBC Optimization Reading (Optional, Measured)',
    description: 'Optional reading materials.',
    collab: '',
    priority: 'MEDIUM',
    isOptional: true,
    hasMeasureTracking: true,
  ...
  },
  {
    ...
    user_id: 'default-user',
    title: 'Test2',
    description: 'Mandatory 30-Day Morning Cardio Running Program to build stamina and heart discipline.',
    collab: '',
    priority: 'HIGH',
    isOptional: false,
    hasMeasureTracking: true,
  ...
  },
  {
    ...
    user_id: 'default-user',
    title: 'Child 2.1 - Warmup Stretches (Mandatory, Measured in Mins)',
    description: 'Stretching before running.',
    collab: '',
    priority: 'MEDIUM',
    isOptional: false,
    hasMeasureTracking: true,
    ...
    currentCount: 18,
    repeatRule: 'DAILY',
    parentTaskId: '22222222-2222-4222-a222-222222222222',
    attachmentName: '',
    isArchived: false,
    archivedAt: null,
    isDoneToday: true,
  ...
  },
  {
    ...
    user_id: 'default-user',
    title: 'Test3',
    description: 'Solving 100 Algorithmic Data Structure & LeetCode problems before final technical interview.',
    collab: '',
    priority: 'CRITICAL',
    isOptional: false,
    hasMeasureTracking: true,
  ...
  },
  {
    ...
    currentCount: 28,
    repeatRule: 'DAILY',
    parentTaskId: '33333333-3333-4333-a333-333333333333',
    attachmentName: '',
    isArchived: false,
    archivedAt: null,
    isDoneToday: true,
